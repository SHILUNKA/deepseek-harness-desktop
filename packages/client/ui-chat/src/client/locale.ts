...
export const zh = {
  ...
  'fileOpen.unknown': '无法打开此文件，可能是系统里没有能打开它的程序',
  'fileOpen.folderTitle': '无法打开文件夹',
  'fileOpen.folderUnknown': '无法打开此文件夹，请确认它是否还在',
  ...
  'message.failure.quota': '余额不足或额度已用完，请充值或更换模型服务商',
  'message.failure.invalidCredential': 'API 密钥格式不正确，请检查设置中填写的密钥',
  'message.failure.missingCredential': '没有配置该服务商的 API 密钥',
  'message.failure.rateLimit': '请求过于频繁，已被服务商限流，请稍后再试',
  'message.failure.server': '服务商暂时不可用，请稍后再试',
  'message.failure.timeout': '请求超时，请检查网络后重试',
  'message.failure.transport': '网络连接失败，请检查网络后重试',
  'message.failure.contextWindow': '本轮内容超出该模型的上下文上限',
  'message.failure.emptyResponse': '模型没有返回任何内容',
...
export const en = {
  ...
  'fileOpen.unknown': 'Couldn’t open this file — no application on this system handles it',
  'fileOpen.folderTitle': 'Couldn’t open folder',
  'fileOpen.folderUnknown': 'Couldn’t open this folder — check that it still exists',
  ...
  'message.failure.quota': 'Balance or quota exhausted — top up, or switch provider',
  'message.failure.invalidCredential': 'API key is malformed — check the key saved in settings',
  'message.failure.missingCredential': 'No API key configured for this provider',
  'message.failure.rateLimit': 'Rate limited by the provider — try again shortly',
  'message.failure.server': 'The provider is temporarily unavailable — try again shortly',
  'message.failure.timeout': 'The request timed out — check your connection and retry',
  'message.failure.transport': 'Could not reach the provider — check your connection and retry',
  'message.failure.contextWindow': "This turn exceeds the model's context limit",
  'message.failure.emptyResponse': 'The model returned no content',
